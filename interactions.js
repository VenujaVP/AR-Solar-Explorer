document.addEventListener("DOMContentLoaded", () => {
    ...
    earthModel.addEventListener("click", () => {
        ...
        // Push Earth UP the screen (-Z) and TOWARDS camera (+Y)
        earthContainer.setAttribute("position", "0 1.5 -2.5"); 
        
        // Scale for inspection
        currentFocusScale = 1.2;
        earthModel.setAttribute("scale", `${currentFocusScale} ${currentFocusScale} ${currentFocusScale}`);
        
        // Ensure Earth spin logic continues
        earthSpinning = true;
